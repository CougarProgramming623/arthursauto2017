...
#define PRACTICE_BOT
    ...
    turnP = prefs->GetDouble("TurnP", 0.05f);
    turnI = prefs->GetDouble("TurnI", 0.00f);
    turnD = prefs->GetDouble("TurnD", 0.10f);

    driveP = prefs->GetDouble("DriveP", 0.03f);
    driveI = prefs->GetDouble("DriveI", 0.00f);
    driveD = prefs->GetDouble("DriveD", 0.00f);
