...
std::shared_ptr<CANTalon> RobotMap::subsystemDrivetreadLeftFront;
std::shared_ptr<CANTalon> RobotMap::subsystemDrivetreadLeftBack;
std::shared_ptr<CANTalon> RobotMap::subsystemDrivetreadRightBack;
std::shared_ptr<CANTalon> RobotMap::subsystemDrivetreadRightFront;
