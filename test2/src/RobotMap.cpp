...
double RobotMap::toleranceDegrees;
...
#define PRACTICE_BOT
    ...
    cantalonRightFront->SetFeedbackDevice(CANTalon::FeedbackDevice::QuadEncoder );
    cantalonRightFront->ConfigEncoderCodesPerRev(360);
    //cantalonLeftFront->SetPosition(position);
    cantalonRightFront->SetEncPosition(0);
    ...
    turnP = prefs->GetDouble("TurnP", 0.075f);
    turnI = prefs->GetDouble("TurnI", 0.04f);
    turnD = prefs->GetDouble("TurnD", 0.26f);

    driveP = prefs->GetDouble("DriveP", 0.075f);
    driveI = prefs->GetDouble("DriveI", 0.04f);
    driveD = prefs->GetDouble("DriveD", 0.26f);

    toleranceDegrees = prefs->GetDouble("Tolerance Degrees", 0.2f);

    prefs->PutDouble("TurnP", turnP);
    prefs->PutDouble("TurnI", turnI);
    prefs->PutDouble("TurnD", turnD);

    prefs->PutDouble("DriveP", driveP);
    prefs->PutDouble("DriveI", driveI);
    prefs->PutDouble("DriveD", driveD);

    prefs->PutDouble("Tolerance Degrees", toleranceDegrees);
